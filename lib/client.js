...
if (typeof window === 'undefined') {
  // Node.js environment - default to SQLite-backed storage unless explicitly disabled
  const cliMode = process.env.INDEXCP_CLI_MODE;
  const useSQLiteStorage = cliMode !== 'false';
  ...
  if (useSQLiteStorage) {
    ...
    // Testing mode: use in-memory fake-indexeddb
